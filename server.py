...
if __name__ == "__main__":
    ...
    from cloud.api.routes import auth, devices, captures, device_commands, admin_codes, capture_events, version, admin, images
    ...
    main_app.include_router(images.router)  # Image serving from Railway volume
